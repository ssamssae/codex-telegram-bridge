...
final/public-flow mirroring from the JSONL session created by that host when enabled. Set
`CRB_FLOW_MIRROR=1`, or create `~/.config/codex-telegram-bridge/flow-mirror.on`, to enable the live-updating flow card.

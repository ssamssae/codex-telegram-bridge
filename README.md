...
```bash
pipx install "git+https://github.com/ssamssae/codex-telegram-bridge.git@v0.3.5"
...
Promo video:
<https://github.com/ssamssae/codex-telegram-bridge/releases/download/v0.3.5/codex-telegram-bridge-promo-v0.3.5.mp4>
